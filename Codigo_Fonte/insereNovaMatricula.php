			...
			'$endereco','$numero','$bairro','$senhaMd5','$id_cidade','$id_turma');";
				...
				WHERE cod_matricula = '$cod_matricula';";
							...
							WHERE id_turma=$id_turma;";
                                    ...
                                    echo '<h2>Login de acesso ao sistema <br/>CPF <b>' . $cpf . '</b><br/> Senha: <b> ' . $senha;
...
';
                                ...
                                while ($dados = mysqli_fetch_assoc($result)) {
                                     ...
                                     */
                                    if ($cpf == $dados['cpf']) {
                                        echo '<br/><a href="novaMatricula.php?cod_matricula=' . $dados['cod_matricula'] . '&id_turma=' . $dados['id_turma'] . '"><button class="btn btn-primary"> Editar matrícula </button></a> &nbsp';
