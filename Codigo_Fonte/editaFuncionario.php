...
if (isset($_GET['id_usuario'])) {
    ...
    $sql = "SELECT * FROM vb_usuario WHERE id_usuario = '$id_usuario';";
                ...
                <div class="row">
                    ...
                    <form method="post" action="insereFuncionario.php" >
                       <div class="col-md-6">
                        ...
                        <button name="limpar" type="submit" class="btn btn-success">Salvar</button>    
                        <button name="limpar" type="reset" class="btn btn-success">Limpar</button>
                    </form>
                </div>
