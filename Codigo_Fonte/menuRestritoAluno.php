                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <ul class="nav navbar-nav" >
                                        <li class="active" align="left" >
                                            <div  align="left" >
                                                 <h3 style="color:#666" >Área do Aluno</h3>
                                                <h3 style="color:#666" >Bem-vindo(a) <?php echo strtoupper($_SESSION["nome"]); ?>!</h3>

                                                <div class="menu" >
                                                    <ul>
                                                        <li><a  align="center" style="color:#000000" href="listaFichas.php">Exercicio</a></li>
                                                        <li><a  align="center" style="color:#000000" href="imc.php">IMC</a></li>
